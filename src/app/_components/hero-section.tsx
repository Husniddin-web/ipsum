      ...
      <div className="container hero-content">
        <div className="hero-info-card" data-aos="fade-up">
          <div>
            ...
            <p>
              IPSUM Pathology объединяет патоморфологию, клинико-диагностические
              исследования и современный сервис, чтобы путь от записи до результата
              был понятным, быстрым и надежным.
            </p>
          </div>
        </div>
