...
export const analysisCategories = [
  ...
  },
  {
    title: "Биохимия",
    description:
      "Показатели обмена веществ, функции печени, почек, сердца и эндокринной системы.",
    count: "18+",
    icon: "flask",
    tone: "blue",
  },
  ...
  },
  {
    ...
    description:
      "Забор биоматериала на дому или в офисе с соблюдением стерильности и логистики.",
    count: "2+",
    icon: "home",
    tone: "red",
  },
